...
public class ProjectManagerTest {
    ...
    public void canBuildProjectsAndPickUpChangesFromMasterBranch() throws Exception {
        ...
        ProjectManager.ExtendedBuildState extendedBuildState = runner.build(buildLog, "master", null, defaultTimeout, "001");
        ...
        BuildState result2 = runner.build(badBuildLog, "master", null, defaultTimeout, "001").buildState;
    ...
    public void canBuildProjectsAndPickUpChangesFromAnyExistingBranch() throws Exception {
        ...
        BuildState result = runner.build(buildLog, "branch-1", null, defaultTimeout, "001").buildState;
        ...
        StringBuilderWriter badBuildLog = new StringBuilderWriter();
        BuildState result2 = runner.build(badBuildLog, "branch-1", null, defaultTimeout, "001").buildState;
        assertThat(buildLog.toString(), result2, is(BuildState.FAILURE));
        assertThat(badBuildLog.toString(), containsString("The build could not read 1 project"));
    ...
    public void canBuildProjectsAndSwitchFromBranch() throws Exception {
        ...
        BuildState result = runner.build(buildLog, "master", null, defaultTimeout, "001").buildState;
        assertThat(buildLog.toString(), result, is(BuildState.SUCCESS));
        assertThat(buildLog.toString(), containsString("BUILD SUCCESS"));


        StringBuilderWriter buildLogBranch1 = new StringBuilderWriter();
        result = runner.build(buildLogBranch1, "branch-1", null, defaultTimeout, "001").buildState;
        ...
        BuildState result2 = runner.build(buildLogMasterAgain, "master", null, defaultTimeout, "001").buildState;
        ...
        BuildState branch1AgainResult = runner.build(buildLogBranch1Again, "branch-1", null, defaultTimeout, "001").buildState;
    ...
    public void canFailBuildIfBranchDoesnotExist() throws Exception {
        ...
        try {
            runner.build(buildLog, "a-non-exist-branch", null, defaultTimeout, "001");
    ...
    public void canBuildProjectsWithParameter() throws Exception {
        ...
        BuildState result = runner.build(buildLog, "master", "Test Parameter", defaultTimeout, "001").buildState;
        assertThat(buildLog.toString(), result, is(BuildState.SUCCESS));
